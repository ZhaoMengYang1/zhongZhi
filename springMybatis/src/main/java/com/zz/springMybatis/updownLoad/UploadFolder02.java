...
@WebServlet("/uploadFolder02")
public class UploadFolder02 extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6220316274180815175L;

	public void doPost(HttpServletRequest request,HttpServletResponse response) {
		System.out.println("uploadFolder02==================");
